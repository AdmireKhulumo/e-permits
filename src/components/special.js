...
const InfoDisplaySpecialPromise=import('../components/InfoDisplaySpecial');
const InfoDisplaySpecial=React.lazy(()=>(InfoDisplaySpecialPromise));
    ...
    render() {
        ...
        let completePermitMarkup=this.state.applicationInfo?(
            this.state.applicationInfo.map(
                (info) => <InfoDisplaySpecial key={info.permitId} info={info}/>)
            ) : <p>Loading...</p>
